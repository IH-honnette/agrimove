...
router.post('/signup', async (req, res) => {
  try {
    ...
    const result = await pool.query(
      'INSERT INTO users (name, email, phone, role, password_hash) VALUES ($1, $2, $3, $4, $5) RETURNING id, name, email, phone, role, created_at',
      [name, email, phone || null, role || 'customer', password_hash]
    );
